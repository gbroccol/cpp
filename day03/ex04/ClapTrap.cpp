...
ClapTrap::ClapTrap(void)
{
	...
	this->_name_color = "\x1b[33;1m";

	std::cout << _name_color << _name << " (ClapTrap): " << "\x1b[0m";
	std::cout << "Hi, now we can start def" << std::endl;
...
ClapTrap::ClapTrap(std::string name)
{
	...
	std::cout << _name_color << _name << " (ClapTrap): " << "\x1b[0m";
	std::cout << "Hi, now we can start name" << std::endl;
...
{
	std::cout << _name_color << _name << " (ClapTrap): " << "\x1b[0m";
	std::cout << "Good think, I don't have a soul!" << std::endl << std::endl;
	return ;
}
