...
/*   Updated: 2021/01/21 21:15:45 by gbroccol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(void)
{
	...
	_level = 1;
	_name = "SCAV TRAP";
	_name_color = "\x1b[31;1m";
	_melee_damage = 20;
	_ranged_damage = 15;
	_armor_damage_reduction = 3;

	std::cout << _name_color << _name << " (ScavTrap): " << "\x1b[0m";
...
{
	std::cout << _name << "(ScavTrap): " << "\x1b[0m";
...
ScavTrap::~ScavTrap()
{
	std::cout << this->_name_color << this->_name << " (ScavTrap): " << "\x1b[0m";
